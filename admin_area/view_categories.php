...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td>
                <a href="index.php?edit_category=<?php echo $category_id ?>" class="btn btn-black">
                    <i class="fa-solid fa-pen-to-square"></i> Edit
                </a>
            </td>
            <td>
                <button class="btn btn-black" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $category_id; ?>">
...
<script>
    ...
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        var modal = $(this);
        modal.find('#confirmDelete').attr('href', 'index.php?delete_category=' + categoryId);
    });
</script>
